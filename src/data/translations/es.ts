...
export const es: Record<TranslationKey, string> = {
  ...
  'common.today': 'hoy',
  'common.daysAgoOne': 'ayer',
  'common.daysAgoOther': 'hace {days} días',
  ...
  'sportLog.otherSummary': 'Sesión registrada',
  ...
  'session.pickTrainingDay': 'Elige un entrenamiento',
  'session.noTrainingDaysFound': 'No se encontraron entrenamientos.',
  'session.gymOnlyHint': 'El snowboard, el ciclismo, la escalada y otras actividades se registran desde la pestaña Entrenamientos.',
  ...
  'home.greetingDay': 'Hola de nuevo',
