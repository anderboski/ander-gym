...
export const en = {
  ...
  'common.today': 'today',
  'common.daysAgoOne': 'yesterday',
  'common.daysAgoOther': '{days} days ago',
  ...
  'trainings.kindLabel': 'Type',
  'trainings.kindHint': "Can't be changed after creation.",
  'trainings.otherActivities': 'Other activities',
  'trainings.otherActivitiesHint': "Logged after the fact, not part of Home's rotation or streak.",
  'trainings.logsCountOne': 'log',
  'trainings.logsCountOther': 'logs',

  'trainingKind.gym': 'Gym',
  'trainingKind.snowboard': 'Snowboard',
  'trainingKind.cycling': 'Cycling',
  'trainingKind.climbing': 'Climbing',
  'trainingKind.other': 'Other',
  ...
  'snow.groomed': 'Groomed',

  'sportLog.logButton': 'Log a session',
  'sportLog.formTitle': 'Log {training}',
  'sportLog.dateLabel': 'Date',
  'sportLog.weatherLabel': 'Weather',
  'sportLog.snowLabel': 'Snow condition',
  'sportLog.commentsLabel': 'Comments',
  'sportLog.commentsPlaceholder': 'How was it? (optional)',
  'sportLog.distanceLabel': 'Distance (km)',
  'sportLog.elevationLabel': 'Elevation gain (m)',
  'sportLog.bpmLabel': 'Average heart rate (bpm, optional)',
  'sportLog.climbsLabel': 'Climbs per grade',
  'sportLog.gradeCountAria': 'Number of grade {grade} climbs',
  'sportLog.couldNotSave': 'Could not save.',
  'sportLog.noLogsYet': 'No sessions logged yet.',
  'sportLog.climbsSummaryOne': '1 climb',
  'sportLog.climbsSummaryOther': '{count} climbs',
  'sportLog.otherSummary': 'Session logged',
  ...
  'session.pickTrainingDay': 'Pick a training day',
  'session.noTrainingDaysFound': 'No training days found.',
  'session.gymOnlyHint': 'Snowboard, cycling, climbing and other activities are logged from the Trainings tab instead.',
  ...
  'session.newPrToast': 'New record — {set}',
